...
pub fn init_tuto(
    ...
    tutorial.add_message("You can see other dimension here every thing a litle more darker is a wall in the other dimmension".to_string(), 3);
    tutorial.add_message("Here the wall is present in both dimension you can't pass it".to_string(), 4);
